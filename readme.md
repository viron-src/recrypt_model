...
When the system is in maintenance mode. Every gRPC response will become blocked via PERMISSION_DENIED error. Maintenance mode can last for extended period of time. See https://x.com/RecryptCS for updates.
...
| PERMISSION_DENIED   | *                | Maintance mode, refer to X account https://x.com/RecryptCS          |
...
| FAILED_PRECONDITION | *                | See Compliance questioning and transaction limits section above     |
| RESOURCE_EXHAUSTED  | a number         | Number of objects exceeded. Message contains the limit you have it. |
| RESOURCE_EXHAUSTED  | *                | API rate limiting hit                                               |
